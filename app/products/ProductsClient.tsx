...
export default function ProductsClient() {
    ...
    if (error) {
        return <p className="mt-24 px-6 text-red-500">Error: {error.message}</p>;
    }
        ...
        <div className="mt-2 px-6 max-w-7xl mx-auto flex flex-col gap-4">
            {temaInfo && (
                ...
                >
                    ...
                    <motion.div className="absolute top-4 right-4 w-20 h-20 opacity-20" style={{ rotate }}>
                        <Image src="/3.png" alt="Decoración" fill style={{ objectFit: "contain" }} />
                    </motion.div>
                    <motion.div className="absolute bottom-4 left-4 w-16 h-16 opacity-20" style={{ rotate: inverseRotate }}>
                        <Image src="/3.png" alt="Decoración" fill style={{ objectFit: "contain" }} />
                    </motion.div>
                </motion.section>
            )}
