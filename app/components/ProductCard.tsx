    ...
    return (
        <div className="rounded-2xl border border-white/40 bg-white/30 backdrop-blur-lg shadow-xl p-6 transition-transform duration-300 hover:scale-[1.03] hover:shadow-2xl flex flex-col justify-between h-full">
            <div className="flex flex-col gap-2 mb-4">
                <h2 className="text-xl font-bold text-center text-gray-800 drop-shadow-sm">{product.name}</h2>
                <p className="text-gray-700 text-sm leading-relaxed">
                    <span className="text-lg font-medium underline">Puede Contener varios de estos elementos: </span>
                    {product.description}
                </p>
            </div>
